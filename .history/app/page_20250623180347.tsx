        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          >
            ...
            <motion.div className="relative w-40 h-40 mx-auto mb-8" variants={floatingVariants} animate="animate">
              <div className={`absolute inset-0 bg-gradient-to-r ${theme.primary} rounded-full blur-lg-2 opacity-50`} />
              <Image
                src={personalInfo.avatar || "/placeholder.svg"}
                alt="Profile"
                fill
                className=" rounded-full object-cover border-5 shadow-2xl relative z-10 "
              />
              <motion.div
